...
execute if score @s aureType matches 4 run item replace entity @s armor.head with minecraft:paper[item_model="surviwar:empty",item_name={text:"tired",color:"yellow"},\
